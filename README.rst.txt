...
self-contained system (SCS). You can read more on SCS architecture `here
(theory)`_ and `here (practical realization)`_.

.. _here (theory): http://scs-architecture.org
.. _here (practical realization): http://galeria-kaufhof.github.io/general/2015/12/15/architektur-und-organisation-im-galeria-de-produktmanagement
